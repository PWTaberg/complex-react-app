...
function HomeGuest() {
  ...
  function ourReducer(draft, action) {
    switch (action.type) {
      ...
      case "emailImmediately":
        console.log("validate email 1");
        draft.email.hasErrors = false;
        draft.email.value = action.value;
        return;
      case "emailAfterDelay":
        console.log("validate email 2");
      ...
      case "passwordImmediately":
        ...
        if (draft.password.value.length > 16) {
          ...
          draft.password.message = "Username cannot exceed 50 characters.";
        }
        return;
  ...
  function handleSubmit(e) {
    ...
    console.log("dispatch email 1");
    dispatch({ type: "emailImmediately", value: state.email.value });
    console.log("dispatch email 2");
    dispatch({
